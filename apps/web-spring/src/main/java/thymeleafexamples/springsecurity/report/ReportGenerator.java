...
public class ReportGenerator {
    ...
    public void generateXLSX(OutputStream stream, List<VkUserPaymentDTO> dtos) {
        try {
            ...
            projectNameValueCell.setCellValue("12344411тесмт");
            ...
            projectPriceValueCell.setCellValue("1000");
            ...
            peopleCountValueCell.setCellValue("64");
            ...
            totalMoneyCellValue.setCellValue("39000");
            ...
            IntStream.range(0, dtos.size())
                    .forEach(idx -> {
                                ...
                                if (dtos.get(idx).getPaymentCapturedAt() != null) {
                                    cell5.setCellValue(dtos.get(idx).getPaymentCapturedAt());
                                }
